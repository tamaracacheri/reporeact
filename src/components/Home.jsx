        ...
        <>
            <div className = "index-banner">
                <div className = "index-banner-container">
                    <img className = "index-banner-img" src = "https://images.pexels.com/photos/1303098/pexels-photo-1303098.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt = "banner"></img>
                </div>
